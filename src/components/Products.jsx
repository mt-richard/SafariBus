...
const Products = () => {
    return (  
        <div className="product">
            ...
            <div className="head md:w-[1580px] flex md:px-[25%]">
                        <div className="line hidden md:block md:w-[100px]  mt-5 "></div>
                        <span className="md:text-[2.125rem] md:w-[450px]  font-bold px-10 text-center">SafariBus products</span>
                        <div className="line md:w-[100px] mt-4 md:mt-5  "></div>
                </div>
                ...
                <div className="container md:flex">
                    <div className="cont1 bg-white rounded m-3 py-3">
