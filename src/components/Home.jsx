...
const Home = () => {
    return (  
        <div className="home md:flex px-5 mt-1 md:px-20 py-10">
          <div className="content w-full text-left md:px-10">
          ...
          <div className="banner mt-5 w-full">
            ...
            <div className="btns flex">
                <button className=" text-white rounded  text-[15px] md:text-[15px] md:px-5 py-1 mr-[2px] mr-1 md:mr-5">Card Pre-Register</button>
                <button className=" text-white rounded  text-[15px] md:text-[15px] md:px-5 py-1 mr-[2px] mr-1 md:mr-5">Card Topup</button>
                <button className=" text-white rounded  text-[15px] md:text-[15px] md:px-5 py-1 mr-[2px]  md:mr-5">Balance</button>
            </div>
          </div>
        </div>
    );
